...
func (s *CheckinService) GetList(ctx context.Context, userID primitive.ObjectID, page, pageSize int) ([]*model.Checkin, int64, error) {
...
func NewSocialService(commentRepo *repository.CommentRepo, likeRepo *repository.LikeRepo, checkinRepo *repository.CheckinRepo, userRepo *repository.UserRepo) *SocialService {
	return &SocialService{commentRepo: commentRepo, likeRepo: likeRepo, checkinRepo: checkinRepo, userRepo: userRepo}
}
